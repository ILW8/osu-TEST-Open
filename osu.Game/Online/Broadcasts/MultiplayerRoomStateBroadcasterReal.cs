...
{
    public partial class MultiplayerRoomStateBroadcasterReal : GameStateBroadcaster<MultiplayerRoomWsState>
    {
        ...
        public MultiplayerRoomStateBroadcasterReal(Room room)
        {
